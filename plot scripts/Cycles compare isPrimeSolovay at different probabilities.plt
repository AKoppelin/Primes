...
title_label(n) = (n==1) ? "isPrimeSolovayPrimes50" : (n==2) ? "isPrimeSolovayPrimes75" : (n==3) ? "isPrimeSolovayPrimes99" : (n==4) ? "isPrimeSolovayPrimes100" : "NOT_IMPLEMENTED"

# number of implementations
n = 4
set title "Function 'isPrimeSolovay' at propabilities 0.5 and 0.75, 0.9999 and 1.0 (primes only)"
