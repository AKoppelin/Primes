...
title_label(n) = (n==1) ? "isPrimeFermatRandomPrimesBig50" : (n==2) ? "isPrimeFermatRandomPrimesBig75" : (n==3) ? "isPrimeFermatRandomPrimesBig100" : "NOT_IMPLEMENTED"

# number of implementations
n = 3
set title "Function 'isPrimeFermatRandom' at propabilities 0.5, 0.75 and 1.0 (big primes only)"
